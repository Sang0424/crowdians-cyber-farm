  ...
  return (
    <div className={styles.settingsPage}>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.settingItem}>
          <div className={styles.settingLeft}>
            ...
            <div>
              <p className={styles.settingLabel}>{t('account.nicknameLabel')}</p>
              {isEditingNickname ? (
                <div className={styles.editRow}>
                  <input
                    ...
                    autoFocus
                  />
                  <button className={styles.editConfirm} onClick={handleNicknameSave}>
                    <Check size={16} />
                  </button>
                  <button className={styles.editCancel} onClick={handleNicknameCancel}>
                    <X size={16} />
                  </button>
                </div>
              ) : (
                <p className={styles.settingValue}>{user?.nickname ?? 'Crowdian'}</p>
              )}
            </div>
          </div>
          {!isEditingNickname && (
            <button className={styles.settingAction} onClick={() => setIsEditingNickname(true)}>
              <Pencil size={16} />
            </button>
          )}
        </div>
        ...
        {/* 비밀번호 변경 */}
        <div className={styles.settingItem} onClick={() => setPasswordModalOpen(true)}>
          <div className={styles.settingLeft}>
            <KeyRound size={20} className={styles.settingIcon} />
            <div>
              <p className={styles.settingLabel}>{t('account.passwordLabel')}</p>
        ...
        {/* 로그아웃 */}
        <div className={styles.settingItem} onClick={() => setLogoutModalOpen(true)}>
          <div className={styles.settingLeft}>
        ...
        >
          <div className={styles.settingLeft}>
            ...
            <div>
              <p className={styles.settingLabelDanger}>{t('account.deleteLabel')}</p>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.settingItem} onClick={() => router.push('/terms')}>
          <div className={styles.settingLeft}>
        ...
        <div className={styles.settingItem} onClick={() => router.push('/privacy')}>
          <div className={styles.settingLeft}>
